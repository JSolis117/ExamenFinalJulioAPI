...
public partial class AnswersDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.AskStatusId).HasName("PK__AskStatu__0329362CC6E70933");
        ...
        {
            entity.HasKey(e => e.CountryId).HasName("PK__Country__10D160BF8F720666");
        ...
        {
            entity.HasKey(e => e.Idconfig).HasName("PK__General__3E2AEF2A8E4BFA55");
        ...
        {
            entity.HasKey(e => e.LikeId).HasName("PK__Like__A2922CF46EF1974D");
        ...
        {
            entity.HasKey(e => e.UserId).HasName("PK__User__1788CCAC039676D3");
        ...
        {
            entity.HasKey(e => e.UserRoleId).HasName("PK__UserRole__3D978A550F2E951D");
        ...
        {
            entity.HasKey(e => e.UserStatusId).HasName("PK__UserStat__A33F541A2B35EAA2");
